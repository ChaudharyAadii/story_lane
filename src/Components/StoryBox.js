...
export default function StoryBox({ users }) {
  // const date = new Date();
  ...
  return (
    <>
      ...
      <div class="ag-format-container">
        {users.map((user) => (<div key={user.id} class="ag-courses_box">
            ...
            <div class="ag-courses-item_link">
              ...
              <div class="ag-courses-item_date-box">
                ...
                <span class="ag-courses-item_date">
                  {/* : {date.getDate()} : {getMonthName(date.getMonth()+1)} : {date.getFullYear()} */}
                  {user.name}
                </span>
              </div>
              <div class="ag-courses-item_date-box">
      ...
      {/* </>{users.map((user) => (<div key={user.id} class="card">
        <div class="content">
          <div class="back">
          ...
          <div class="front">
            ...
            <div class="front-content">
              <small class="badge">{user.story}</small>
